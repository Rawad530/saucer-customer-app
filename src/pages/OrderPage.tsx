...
  const getSummary = useCartStore((state) => state.getSummary);
  ...
  useEffect(() => {
    ...
    if (session || deliveryDetails) {
      // If logged in OR it's a delivery order, clear guest info state.
      setGuestInfo(null);
    } else {
      // If NOT logged in AND NOT a delivery order (i.e., guest pickup)
  ...
  }, [session, deliveryDetails, loadingMenu, hasHydrated]);
