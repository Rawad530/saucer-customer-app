...
  L       <div className="lg:col-span-2 space-y-6">
...
  A               <p className="text-sm text-gray-400">Your Favorite Item:</p>
...
                  t   <p className="text-gray-400">{announcement.content}</p>
                    </div>
                  ))}
                </div>
              </div>
...
    A             <Gift className="w-4 h-4" /> Invite
                </Link>
              </div>
            </div>
...
            <div className="bg-gray-800 p-6 rounded-lg">
Click         <h3 className="flex items-center text-xl font-bold mb-4"><Truck className="w-6 h-6 mr-2 text-gray-300" /> Delivery Partners</h3>
...
Click           <span className="text-xs text-gray-400">Glovo</span>
                </a>
              </div>
            </div>
          </div>
